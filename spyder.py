# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 13:15:39 2021
"""
#ui.py
...
def quit(event):
    ...
    window.quit()
window.title("Disease Detector")

window.geometry("510x540")
window.configure(background ="lightblue")

title = tk.Label(text="Click below to choose picture for testing disease....", background = "lightblue", fg="Brown", font=("", 15))
title.grid()
def bact():
    window.destroy()
    window1 = tk.Tk()

    window1.title("Diseaes Detector")

    window1.geometry("520x530")
    window1.configure(background="lightblue")

    def exit():
        window1.destroy()
    rem = "The remedies for BrownSpot are:\n\n "
    remedies = tk.Label(text=rem, background="lightblue",
                      fg="Brown", font=("", 15))
    ...
    remedies1 = tk.Label(text=rem1, background="lightblue",
                        fg="red", font=("", 12))
    remedies1.grid(column=0, row=8, padx=20, pady=20)
...
def vir():
    ...
    window1.title("Disease Detector")
    ...
    def exit():
        window1.destroy()
    rem = "The remedies for Leaf Smut disease are: "
    remedies = tk.Label(text=rem, background="lightblue",
                      fg="Brown", font=("", 15))
    remedies.grid(column=0, row=7, padx=10, pady=10)
...
def latebl():
    ...
    def exit():
        window1.destroy()
    rem = "The remedies for Bacterial leaf blight are: "
    remedies = tk.Label(text=rem, background="lightblue",
                      fg="Brown", font=("", 15))
    remedies.grid(column=0, row=7, padx=10, pady=10)
    ...
    remedies1 = tk.Label(text=rem1, background="lightblue",
                         fg="Black", font=("", 12))
    remedies1.grid(column=0, row=6, padx=10, pady=10)
...
def analysis():
    ...
    from tqdm import \
        tqdm   
    verify_dir = "C:\\Users\\Akhila\\miniproject\\Dataset\\testpic"
    IMG_SIZE = 50
    LR = 1e-3
    ...
    for num, data in enumerate(verify_data):
        ...
        message = tk.Label(text='Status: '+status, background="lightblue",
                           fg="Brown", font=("", 15))
        message.grid(column=0, row=3, padx=10, pady=10)
        if str_label == 'BrownSpot':
            diseasename = "Brown Spot "
            disease = tk.Label(text='Disease Name: ' + diseasename, background="lightblue",
                               fg="Black", font=("", 15))
            disease.grid(column=0, row=4, padx=10, pady=10)
            r = tk.Label(text='Click below for remedies...', background="lightblue", fg="Brown", font=("", 15))
        ...
        elif str_label == 'Leaf Smut':
            diseasename = "Leaf Smut Disease "
            disease = tk.Label(text='Disease Name: ' + diseasename, background="lightblue",
                               fg="Black", font=("", 15))
            disease.grid(column=0, row=4, padx=10, pady=10)
            r = tk.Label(text='Click below for remedies...', background="lightblue", fg="Brown", font=("", 15))
            ...
            button3.grid(column=0, row=6, padx=10, pady=10)
        elif str_label == 'Bacterial Leaf Blight':
            ...
            r = tk.Label(text='Plant is healthy', background="lightblue", fg="Black",
                         font=("", 15))
...
def openphoto():
    dirPath = "C:\\Users\\Akhila\\miniproject\\Dataset\\testpic"
    ...
    fileName = askopenfilename(initialdir='C:\\Users\\Akhila\\miniproject\\Dataset', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:\\Users\\Akhila\\miniproject\\Dataset\\testpic"
